      ...
      <main className="pt-24 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 fade-in max-w-5xl">
              {projects.map((project, index) => (
                ...
                >
                  {/* Project image */}
                  <div className="h-80 bg-white/5 rounded-2xl flex items-center justify-center text-8xl relative overflow-hidden mb-6 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-white/10">
