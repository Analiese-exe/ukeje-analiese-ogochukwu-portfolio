    ...
    <nav className="navbar-3d fixed top-6 left-1/2 transform -translate-x-1/2 z-50 rounded-full px-6 py-3">
      <div className="flex items-center gap-6">
        ...
        <Link 
          to="/projects"
          className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 ${
            location.pathname === '/projects' ? 'bg-white/20' : 'hover:bg-white/10'
          }`}
        >
        ...
        <Link 
          to="/blog"
          className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 ${
            location.pathname === '/blog' ? 'bg-white/20' : 'hover:bg-white/10'
          }`}
        >
        ...
        <Link 
          to="/contact"
          className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 ${
            location.pathname === '/contact' ? 'bg-white/20' : 'hover:bg-white/10'
          }`}
        >
