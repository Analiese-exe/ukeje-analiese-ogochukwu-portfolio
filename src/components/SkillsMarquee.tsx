  ...
  return (
    <section className="py-16 overflow-hidden">
      <div className="relative">
        {/* Static centered marquee container */}
        <div className="flex justify-center items-center gap-16 static-marquee fade-in">
          {tools.map((tool, index) => (
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center transition-all duration-300 hover:scale-110">
                <tool.icon className="w-8 h-8 text-white group-hover:scale-125 transition-transform" />
              </div>
            </div>
          ))}
        </div>
